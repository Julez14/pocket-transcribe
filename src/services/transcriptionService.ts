...
// This would be replaced with your actual STT service URL
const TRANSCRIPTION_SERVICE_URL = 'https://api.example.com/transcribe';
  ...
  try {
    ...
    if (process.env.NODE_ENV === 'development') {
      ...
      return new Promise((resolve) => {
        setTimeout(() => {
          resolve('This is a simulated transcript of your recorded audio. In a production environment, this would be the actual transcribed text from your audio recording.');
